...
//! [`FilterPipeline`]. Two handler variants exist: [`PingoraHttpHandler`]
//! enables body filter hooks when the pipeline declares body access;
//! [`PingoraHttpHandlerNoBody`] skips them for zero-overhead forwarding.
//!
